...
### predict on test set/calculate prediction for all samples
...
MSEP_test_full_model=pred_test_snpboost$metric

cor_squared_test_full_model=cor(data[data$train_test=="test",]%>%pull(all_of(phenotype)),pred_test_snpboost$prediction)^2
...
save.image(file=paste0("results/",phenotype,"_snpboost_covariates.RData"))